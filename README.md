...
│                                                                         │
│   ┌───────────────────────┐       ┌───────────────────────────────┐     │
│   │   (restaurant_db)     │       │   (Kafka Surface — port 9093) │     │
...
└──────────────┼───────────────────────────────────┼───────────────────── ┘
               ...
               ▼                                   ▼
┌─────────────────────────────────────────────────────────────────────────┐
│                    🥉 BRONZE LAYER  (ws_dbxproject.01_bronze)          │
│                                                                         │
...
└─────────────────────────────────────────┬───────────────────────────────┘
                               ...
                               + Data Quality Expectations
                                          ...
                                          ▼
┌─────────────────────────────────────────────────────────────────────────┐
│                    🥈 SILVER LAYER  (ws_dbxproject.02_silver)          │
│                                                                         │
...
└─────────────────────────────────────────┬───────────────────────────────┘
                               ...
                               (Incremental Processing)
                                          ...
                                          ▼
┌─────────────────────────────────────────────────────────────────────────┐
│                    🥇 GOLD LAYER  (ws_dbxproject.03_gold)               │
│                                                                         │
...
│   |
│   |--00_sql_db.py                           # Generate 5 UAE locations, 500 customers and 145 menu items
│   |--01_historical_orders.py                # ~8,000 orders over 6 months
|   |--02_reviews.py                          # Customer reviews with ratings
│   |--03_run.py                              # Generate all data at once
│   |--04_eventhub_orders.py                  # Live order stream → Event Hub (every 3s)
│
├── ingestion/
...
All data is synthetically generated using Python scripts in `/synthetic_data/`. The data is designed to be realistic — UAE cities, Indian restaurant names, authentic menu items, and plausible order patterns.
...
**Stack:** Azure Databricks · Delta Lake · Unity Catalog · LakeFlow · Spark Declarative Pipelines · Mosaic AI
